...
assert 20 'main() { int a; a = 3; a = 3 + 7; int b; b = (1+7)/(1+3); return a * b; }'
assert  8 'main() { int aaaa; aaaa = 3; int aaab; aaab = 5; return aaaa+aaab; }'
assert  7 'main() { int a; int b; a = 4; b = 10; return (a + b)/2; return a; }'
...
assert  4 'main() { int a; a = 1; if (10>9) { int b; b = 3; a = a + b;} return a; }'
assert 10 'main() { int a; a=10; foo(); return a; }'
assert 22 'main() { int a; a=12; int b; b=34; bar(a, b); return b-a; }'
...
assert 15 'main() { int x; int p; x = 15; p = &x; return *p; }'
